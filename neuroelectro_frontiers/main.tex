...
\begin{figure*}[htbp!]
\centering
\includegraphics[scale = 1]{figures/metadata_assignment_accuracy_v2.jpg}
...
To facilitate further data integration efforts, we advocate small shifts in how investigators analyze and report neurophysiological data.  
...
We also ask that physiologists report more basic physiological information within articles and, if possible, publish such data using machine-readable formats like data tables.  
Similarly, relevant experimental details should be clearly stated within the methods section (e.g., liquid junction potential correction).  
