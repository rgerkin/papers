...
It allows many neurophysiological and neuroanatomical models to be described in a simulator-independent fashion. Some simulators, notably the popular NEURON package\todo{cite NEURON}, can seamlessly export model specifications in the NeuroML format. 
