...
\title[Running Title]{NeuronUnit: Collaborative Validation Testing of Neurophysiological Models}
...
This has made it difficult to develop compare competing models, to determine the state-of-the-art, and to precisely identify open modeling problems.

Software engineers validate software by writing simple executable tests, called ``unit tests''. 
